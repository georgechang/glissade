...
export default defineConfig({
  resolve: {
    alias: {
      '@glissade/shared': r('./packages/shared/src/index.ts'),
      '@glissade/scroll-engine': r('./packages/scroll-engine/src/index.ts'),
      '@glissade/extension': r('./packages/extension/src/index.ts'),
    },
  },
  test: {
    environment: 'node',
